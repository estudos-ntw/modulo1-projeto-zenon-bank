...
public class Main {
    ...
    void main() throws IOException {
        ...
        var notFoundOriginName = "C123456";
        transactionRepository.findByOriginName(notFoundOriginName)
                .ifPresentOrElse(IO::println, () -> IO.println("Transactions not found " + notFoundOriginName));

        IO.println("---------------------------------------------------------------------------------------");

        var existingOriginName = "C1868032458";

        long startTimeList = System.nanoTime();
        transactionRepository.findByOriginName(existingOriginName)
                .ifPresentOrElse(IO::println, () -> IO.println("Transactions not found " + existingOriginName));
        ...
        IO.println("Tempo de Busca - Map (ms): " + (endTimeMap - startTimeMap) / 1_000_000.0 + " ms");
        /*
